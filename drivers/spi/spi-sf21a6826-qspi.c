...
/*
 * A driver for Siflower SF21A6826 QSPI controller.
 *
				    ...
				    struct ssp_clock_params *clk_freq)
{
	...
	WARN(!best_freq, "sf_qspi: Matching cpsdvsr and scr not found for %d Hz rate \n",
			freq);
...
static const struct of_device_id sf_qspi_ids[] = {
	{.compatible = "siflower,sf21a6826-qspi"},
	{},
};
